...
def main():
    ...
    for option_state in list(state_cities.keys())[10:15]:
...
if __name__ == "__main__":
    ...
    df = pd.DataFrame(data, columns=["Showroom Name", "Address", "Phone", "City", "Email", "State"]).drop_duplicates()
        
    # Save updated file
    filename = f"tvs_showrooms3_{today}.csv"
